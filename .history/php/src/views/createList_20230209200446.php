...
<head>
            ...
            let private_item = $(`<div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h3 class="card-title"><input type="date" class="form-control" id="endDate" placeholder="Podaj nazwe"></h3>
                                <h6 class="card-subtitle mb-2 text-muted">asdsad</h6>
                                <p class="card-text">asdasd</p>
                                <input class="btn btn-primary" id="add_tolist" type="button" value="Dodaj">
                            </div>
                        </div>
                    </div>`);
    let loadData = (param,_category) => {
      ...
      <div class="card">
        <div class="card-header img-atas" style="background-image: url('https://source.unsplash.com/ZCoqcrWp9GY'); background-position: 50% 10%;">
        </div>
        <div class="card-body">
          <div class="row">
    ...
    let generateContent = (_item,_qty) => {
        ...
        content.empty()
        console.log(_qty);
        let listItems = _item.map((item) => { return $(`<h5>${searchedProduct(+item)}</h5><input type="number" id="qty" value="1">`)})
