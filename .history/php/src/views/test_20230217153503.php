...
foreach($products->product_id as $key => $value){
    echo $products->product_id[$key]." ".$products->product_title[$key]." ".$products->qty[$key]."<br>";
    //listname!!!
    //$db->createListItems($products->qty[$key], $prod->list_name, $products->product_id[$key]);
    echo "<br>";
}
...
//echo $db->getData('products');
//echo $db->searchData('list','','');
echo "<br>";
echo "<br>";
//echo $db->getData('n','');
//echo $db->deleteList(1)
echo $db->createListItems(2,1,'','63ef903363b33');
//echo $db->addPrivateItem(uniqid(),'mydło',1);
?>