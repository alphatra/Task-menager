            ...
            let private_item = $(`<div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input class="btn btn-primary mt-2" id="add_tolist" type="button" value="Dodaj" data-product-id="9999" data-product-name="asdasd" data-product-category="${$('#privItem_category').val()}" data-product-quantity="1">
                            </div>
                        </div>
                    </div>`);
