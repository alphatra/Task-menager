    ...
    <div class="d-sm-flex flex-column">
        ...
        <div class="d-sm-flex flex-row">
            <div class="black-border flex-fill">
                <div class="m-auto fill- col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                    <input id="search" name="search" type="search" class="form-control text-center" aria-label="Search" placeholder="Wyszukaj po nazwie lub dacie">
                </div>
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" id="listItem">
                        <button type="button" class="btn btn-primary">Dodaj do listy</button>
                    </div>
