...
<head>
            ...
            let private_item = $(`<div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input class="btn btn-primary mt-2" id="add_tolist" type="submit" value="Dodaj" data-product-id="9999" data-product-name="asdasd" data-product-category="${$('#privItem_category').val()}" data-product-quantity="1">
                            </div>
                        </div>
                    </div>`);
  ...
  $('#privItem_category').append($("<option>", {
    ...
    let productName = $('#priv_item').val();
    console.log("Nazwa produktu: " + productName);

    let productCategory = $('#privItem_category').val();
    console.log("Kategoria produktu: " + productCategory);
