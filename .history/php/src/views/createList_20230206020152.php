...
<head>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <input class="btn btn-primary" type="button" id="product" value="Dodaj" name="${item.id_product}">
                            </div>
                        </div>
                    </div>
                    `)
    ...
    let products = [];
    let list = {name:$("#listName").val(), end_date:$("#endDate").val(), products:products};
    ...
    $("#endDate").on("change", function() {
        list.end_date = $(this).val();
        console.log(list);
    })
    $("#product").on("click", function() {
        let val = $(this).attr("name");
        // Sprawdzenie, czy produkt już istnieje w tablicy
