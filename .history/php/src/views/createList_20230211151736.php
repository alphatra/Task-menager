...
<head>
    ...
    let generateContent = (_item,_qty) => {
        ...
        let listItems = _item.map((item) => { 
            return $(`
            <p>${searchedProduct(+item)}</p>
            <input type="number" id="qty" value=1 form-icon-trailing" />
            `)})
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <hr class="hr1" />
                <div id="list_elements" class="px-3 py-3 d-inline-block" style="background-color:#D9D9D9"></div>
                <hr class="hr1" />
