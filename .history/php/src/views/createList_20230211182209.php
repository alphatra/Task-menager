            ...
            let private_item = $(`<div class="col-xl-3 col-lg-4 col-md-6 col-12 mb-4">
                        <div class="card">
                            <div class="card-body">
                                ...
                                Nazwa: 
                                <input type="text" class="form-control mb-2" id="priv_item" placeholder="Nazwa przedmiotu" value="asdasd">
                                Kategoria: <select id="privItem_category" class="form-select">
                                    <option selected>Wybierz kategorię</option>
                            
                                    </select>
                                <input class="btn btn-primary mt-2" id="add_tolist" type="button" value="Dodaj" data-product-id="9999" onclick="alert("AS")" data-product-name="${$('#priv_item').val()}" data-product-category="${$('#privItem_category').val()}" data-product-quantity="1">
                            </div>
                        </div>
                    </div>`);
