            ...
            <div class="black-border flex-fill">
                <form class="row g-3 needs-validation" novalidate>
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="listName" value="Mark" required>
                        <div class="valid-feedback">
                            Podaj nazwę listy!
                        </div>
                    </div>
                    <div class="col-md-4">
                        <label for="endDate" class="form-label">Nazwa Listy</label>
                        <input type="date" class="form-control" id="endDate" value="Mark" required>
                        <div class="valid-feedback">
                            Podaj nazwę listy!
                        </div>
                    </div>
