...
<head>
    ...
    let addList = () => {
        ...
        $.ajax({
            ...
            dataType: 'json',
            method: 'POST',
            data:{tablename:"lists", list: list},
            beforeSend: function() {
                $("#loading-image").show();
             },
            success: function(data) {
        ...
        <div class="d-sm-flex flex-row">
            <div class="black-border flex-fill">
                <form class="row g-3 needs-validation" novalidate>
                    <div id="listName_" class="col-md-4">
                    ...
                    <div id="endDate_" class="col-md-4">
                    ...
                    <div id="searchItem_" class="col-md-4">
                        <label for="endDate" class="form-label">Wyszukaj element z listy</label>
                        <input type="search" class="form-control" id="searchItem" required>
                    </div>
                </form>
            ...
            <div class="black-border flex-shrink-1 flex-grow-0">
                ...
                <hr class="hr" />
                <button type="submit" onclick="addList()" class="btn btn-primary">Uwtórz listę</button>
