...
class db{
    ...
    */
    ...
    public function test($Data){
        ...
        $this->product_name = $decoded_json['product_name'];
        $this->product_description = $decoded_json['product_description'];
        $this->product_image = $decoded_json['product_image'];
        $this->category_id = $decoded_json['category_id'];
        return $product_name;
    }
}
?>