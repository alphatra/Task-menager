...
class db{
    ...
    */
    ...
    public function createListItems($qty,$list_id,$id_product){
        $id = $this->getMaxId('list_items');
        $this->qty = $qty;
        $this->list_id = getIdList($list_id);
        $this->id_product = $id_product;
        
        $query = "INSERT INTO list_items (id, quantity, list_id, id_product) VALUES ('{$id}', '{$this->qty}', '{$this->list_id}', '{$this->id_product}')";
        //mysqli_query($this->conn, $query);
        return $list_id;
    }
}
