    ...
    $(document).on("click", "Button[data-property=Add]", function() {
        ...
        $.ajax({
            ...
            success: function(result) {
                ...
                var row_i = $('#myTable tr').eq(-1);
                var row_j = $('#myTable tr').eq(-2);

// przesuwamy wiersz i przed wiersz j
                row_i.detach().insertBefore(row_j);

// przesuwamy wiersz j przed wiersz i
                row_j.detach().insertBefore(row_i);
