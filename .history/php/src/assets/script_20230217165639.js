$(document).ready(function() {
    ...
    $(document).on("click", "Button[data-property=Edit]", function() {
        ...
        var deleteButton = $('<button>').text('Delete').attr('data-property', 'Delete').attr('data-list-name', _output[productId].name);
  ...
  // utworzenie wiersza nagłówka
        ...
        $.each(_output[productId].products, function(index, product) {
            ...
            table.append(row);
            last_i = index
            deleteButton = $('<button>').text('Delete').attr('data-property', 'Delete').attr('data-list-name', _output[productId].name);
