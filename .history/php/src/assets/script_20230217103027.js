        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(output, function(index, list) {
                    ...
                    let deleteButton = $('<button>').addClass('').attr('id', 'Delete').attr('data-product-id', index).text('Usuń');
                    let editButton = $('<button>').addClass('').attr('id', 'Edit').attr('data-product-id', index).text('Edytuj');
