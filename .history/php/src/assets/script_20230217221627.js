            ...
            success: function(data) {
                ...
                $.each(_output, function(index, list) {
                    ...
                    $.each(list.products, function(key, product) {
                        let listItem = $('<li>').addClass('row');
                        let pname = $('<p>').addClass('').text(product.product_name);
                        let pquantity = $('<p>').addClass('').text(product.quantity);
                        listItem.append(pname, pquantity);
