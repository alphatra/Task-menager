$(document).ready(function() {
  ...
  // utworzenie wiersza nagłówka
        ...
        $.each(_output[productId].products, function(index, product) {
            ...
            var row = $('<tr>');
            console.log(product);
            let input_name = $('<input>').attr('type', 'text').attr('org-name', product.product_name);
            ...
            $('<td>').append(input_name.attr('value',product.product_name)).appendTo(row);
    ...
    $(document).on("click", "button[data-property=Set-item]", function() {
        ...
        var name = $('input[name=name]').val(); // pobranie wartości z inputa
