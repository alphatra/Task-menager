        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(output, function(index, list) {
                    ...
                    var deleteButton = $('<button>').addClass('').attr('data-property', 'Delete').attr('data-product-id', index).text('Usuń');
                    var editButton = $('<button>').addClass('').attr('data-property', 'Edit').attr('data-product-id', index).text('Edytuj');
