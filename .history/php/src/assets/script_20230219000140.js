$(document).ready(function() {
    ...
    const groupByList = (data) => {
        const result = data.reduce((acc, { name, list_id, product_name, quantity, created_date, end_date, priority }) => ({
        ...acc,
        [name]: {
        name,
        created_date,
        ...
        priority,
        list_id,
        products: [...(acc[name]?.products || []), { product_name, quantity,list_id }],
        },
        }), {});
