        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $.each(output, function(index, list) {
                    let div = $('<div>').addClass('col-lg-3 col-md-5 col-sm-5 mb-4 block_list rounded-3').attr('data-priority', list.priority);
                    let tittle = $('<h4>').text(list.name);
                    ...
                    div.append(tittle, elements, editButton, deleteButton);
                    content.append(div);
                });
