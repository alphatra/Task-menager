                ...
                $.each(_data, function(key, value) {
                    $.each(value, function(index, item) {
                        ...
                        $.each(item, function(key, value) {
                            ...
                            let editBtn = $('<button>').addClass('btn btn-primary').attr('id', 'Edit_list').attr('data-product-id', value.list_id).text('Edytuj');
                            let deleteBtn = $('<button>').addClass('btn btn-danger').attr('id', 'Delete_list').attr('data-product-id', value.list_id).text('Usuń');
